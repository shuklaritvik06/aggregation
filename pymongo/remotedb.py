...
client = pymongo.MongoClient(
    "mongodb+srv://username:password@cluster0.aeiaykn.mongodb.net/?retryWrites=true&w=majority"
)
db = client.School
...
datas = [
    {
        "name": "CSE",
        "address": "First Floor",
        "teachers": ["Divya", "Shwetank", "Rahul"],
    },
    {"name": "ECE", "address": "Second Floor", "teachers": ["Shahu", "Rajut"]},
